...
public class SolarProtocolDecoder1 extends BaseProtocolDecoder {

	/**
	 * Initialize
	 */
	public SolarProtocolDecoder1(ServerManager serverManager) {
		super(serverManager);
	}
	...
	private Position decodeNormalMessage(ChannelBuffer buf, Channel channel)
		...
		try {
			...
			if (!pattern.matcher(imeiNo).matches()) {
				...
				ChannelBufferTools.updateHistoryForProtocol2(session,
