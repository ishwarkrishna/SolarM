...
public class UPSFrameDecoder extends FrameDecoder {
    ...
    protected Object decode(
        ...
        //System.out.println("Length of the data string is not valied :"+(endIndex-beginIndex)+" endIndex "+endIndex+" beginIndex"+beginIndex);
 		if ((endIndex-beginIndex)!=41){
