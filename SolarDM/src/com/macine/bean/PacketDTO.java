...
public class PacketDTO {
	...
	public String toString() {
		return "PacketDTO [packet=" + packet + ", timestamp=" + timestamp
				+ ", imeiNo=" + imeiNo + ", data1=" + data1 + ", data2="
				+ data2 + ", data3=" + data3 + ", data4=" + data4 + ", data5="
				+ data5 + ", data6=" + data6 + ", data7=" + data7 + ", data8="
				+ data8 + ", data9=" + data9 + ", data10=" + data10
				+ ", data11=" + data11 + ", data12=" + data12 + ", data13="
				+ data13 + ", data14=" + data14 + ", data15=" + data15
				+ ", data16=" + data16 + ", data17=" + data17 + ", data18="
				+ data18 + ", data19=" + data19 + "]";
	}
}
