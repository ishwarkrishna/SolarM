...
<%@ page import="com.macine.service.web.MachineDetailServices" %>     
...
<body>
	...
	<param name="FlashVars" value="userLocId=<%=userLocId%>"/>
	<embed src='SolarHome.swf' wmode="opaque"
		flashVars="userLocId=<%=userLocId%>"
		quality="high" bgcolor="#ffffff" width="100%" height="450"
